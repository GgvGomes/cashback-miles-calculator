...
export const clube: ConteudoSeo = {
  ...
  resumo:
    "Esta calculadora de clube de pontos compara o que você paga por mil pontos na assinatura com o que eles devolvem no resgate que você vai fazer. Custo, já com bônus, em até 80% do valor do resgate: assine. Acima disso: espere a próxima promoção.",
  secoes: [
    {
      titulo: "O que é um clube de assinatura de pontos",
      paragrafos: [
        "Clube de assinatura é um plano mensal: você paga uma mensalidade fixa e o programa credita uma quantidade fixa de pontos todo mês. Livelo e Esfera são programas de coalizão (os pontos ainda precisam ser transferidos para uma companhia aérea); Smiles, LATAM Pass e Azul Fidelidade são programas aéreos (a milha já nasce onde vira passagem).",
        "O ponto mensal quase nunca é o principal benefício. O que faz um clube valer a pena é o resto: validade do saldo congelada, bônus permanente de transferência e, acima de tudo, a oferta de adesão. A preço de tabela, todo clube entrega um CPM (custo por mil pontos) pior do que o preço-alvo de compra de qualquer programa.",
      ],
    },
    {
      ...
      paragrafos: [
        ...
        "Exemplo: Clube Livelo Classic a R$ 44,90 por 1.000 pontos ao mês (site da Livelo, 2026-08-18; o preço muda, e a calculadora mostra fonte e data de cada plano). CPM = R$ 44,90. Resgate-alvo: R$ 1.200 em dinheiro ou 40.000 milhas + R$ 120 de taxas, valor por mil = 1.080 ÷ 40 = R$ 27,00, teto R$ 21,60. Com 80% de bônus de transferência, o CPM efetivo cai para R$ 24,94, ainda acima. Não assine. Numa adesão promocional que leve o CPM a R$ 14,56, o efetivo vira R$ 8,09. Aí sim.",
      ],
    },
    {
      titulo: "Armadilhas: validade, carência e cancelamento",
      paragrafos: [
        "Carência é o tempo mínimo que você fica obrigado a pagar, e a multa entra no CPM: Clube Smiles plano 1.000 a R$ 44/mês, carência de 6 meses, cancelado no terceiro mês: 6 × 44 = R$ 264 por 3.000 pontos, ou R$ 88 por mil. O CPM dobrou porque você saiu na hora errada. Confira também se a validade do lote do clube (não a do programa) alcança a data da viagem.",
        "Cancelar nem sempre é neutro: no Clube Livelo, quem cancela fica 365 dias fora das campanhas promocionais de contratação, justamente as que fazem o clube valer a pena. Veja se pausar ou migrar de plano resolve. A calculadora cobre só o número; as outras condições (destino definido em até 12 meses, ficar além da carência, o clube resolver algo que a compra avulsa não resolve) são um checklist seu.",
      ],
    },
  ],
  faq: [
